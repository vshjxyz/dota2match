...
exports.syncDota2Heroes = function (language) {
    ...
    if (['en_us'].indexOf(language) === -1) {
        console.error('You must specify a valid language parameter to sync the heroes!');
        return;
    }
